...
!function() {
    ...
    var l = (c.navigator || {}).userAgent, v = void 0 === l ? "" : l, z = c, a = h, m = (z.document, 
    ...
    var s = z || {};
    s[m] || (s[m] = {}), s[m].styles || (s[m].styles = {}), s[m].hooks || (s[m].hooks = {}), 
    s[m].shims || (s[m].shims = []);
    var H = s[m];
    function V(c, v) {
        var h = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks, l = void 0 !== h && h, z = Object.keys(v).reduce(function(c, h) {
            var l = v[h];
            return !!l.icon ? c[l.iconName] = l.icon : c[h] = l, c;
        }, {});
        "function" != typeof H.hooks.addPack || l ? H.styles[c] = function(z) {
            for (var c = 1; c < arguments.length; c++) {
                var a = null != arguments[c] ? arguments[c] : {}, h = Object.keys(a);
