...
!function() {
    ...
    ~h.indexOf("MSIE") || h.indexOf("Trident/"), "___FONT_AWESOME___"), a = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    var f = s[M];
    function H(c, h) {
        var z = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks, l = void 0 !== z && z, v = Object.keys(h).reduce(function(c, z) {
            var l = h[z];
            return !!l.icon ? c[l.iconName] = l.icon : c[z] = l, c;
        }, {});
        "function" != typeof f.hooks.addPack || l ? f.styles[c] = function(v) {
            ...
            return v;
        }({}, f.styles[c] || {}, v) : f.hooks.addPack(c, v), "fas" === c && H("fa", h);
    }
    var e = {
