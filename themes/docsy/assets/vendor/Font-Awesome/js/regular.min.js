...
!function() {
    ...
    var h = (c.navigator || {}).userAgent, v = void 0 === h ? "" : h, l = c, m = z, s = (l.document, 
    !!m.documentElement && !!m.head && "function" == typeof m.addEventListener && m.createElement, 
    ~v.indexOf("MSIE") || v.indexOf("Trident/"), "___FONT_AWESOME___"), M = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    var a = l || {};
    a[s] || (a[s] = {}), a[s].styles || (a[s].styles = {}), a[s].hooks || (a[s].hooks = {}), 
    a[s].shims || (a[s].shims = []);
    var H = a[s];
    function V(c, v) {
        var z = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks, h = void 0 !== z && z, l = Object.keys(v).reduce(function(c, z) {
            var h = v[z];
            return !!h.icon ? c[h.iconName] = h.icon : c[z] = h, c;
        }, {});
        "function" != typeof H.hooks.addPack || h ? H.styles[c] = function(l) {
            for (var c = 1; c < arguments.length; c++) {
                ...
                "function" == typeof Object.getOwnPropertySymbols && (z = z.concat(Object.getOwnPropertySymbols(m).filter(function(c) {
                    ...
                    var z, h, v;
                    z = l, v = m[h = c], h in z ? Object.defineProperty(z, h, {
                        value: v,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            return l;
        }({}, H.styles[c] || {}, l) : H.hooks.addPack(c, l), "fas" === c && V("fa", v);
    }
    var e = {
