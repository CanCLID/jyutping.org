    ...
    function C() {
        ...
        var e = function(t) {
            for (var c = Array.from(u.scripts).filter(function(e) {
                ...
                n.setAttribute("id", b);
                var o = v(c[e]);
                n.setAttribute(w, o), a[o] = c[e], "" !== c[e].src && (n.src = c[e].src), "" !== c[e].innerText && (n.innerText = c[e].innerText), 
                n.async = !0;
            ...
            for (var o = {}, r = 0; r < e.length; r++) {
                ...
                i.setAttribute("id", b), i.setAttribute("href", e[r].href), i.setAttribute("rel", e[r].rel);
                var c = v(e[r]);
                i.setAttribute(w, c), o[c] = e[r], n(i, c);
            }
            for (var a = 0; a < t.length; a++) {
                var s = u.createElement("style");
                s.setAttribute("id", b);
                var f = v(t[a]);
                s.setAttribute(w, f), s.innerText = t[a].innerText, o[f] = t[a], n(s, f);
            }
            return o;
