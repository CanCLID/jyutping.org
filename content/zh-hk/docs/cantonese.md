...
大家可能會覺得，點解要將 eo 同 oe 分開？呢兩個唔系同一個音來嘅咩？其實唔系。eot6 系「術」字嘅韻母，但系 oet6 字就係另一個音了（聽下面嘅錄音）。「食完飯 oet6 一啖氣出來」，就係呢個韻母 oet6。
...
{{< alert color="success">}}
呢個音嘅國際音標系 [ŋ]。普通話冇呢個聲母，而粵語入邊聲母 ng- 同零聲母 Ø- 係區分嘅。而家好多廣州人都分唔出了，例如將「我」字發成 o5，但系其實個發音係 ngo5。（好彩輸入法可以開模糊音，所以如果實在分唔到就開模糊音啦，冚唪唥打嗮 ng- 開頭就得）。
{{< /alert >}}
