...
<table class="tg">
  <tr>
    <th class="tg-teg3">i [iː] 詩 {{< audio id="si1" >}}<br/>i<sub>followed by -ng, -k</sub> [e] 星 {{< audio id="sing1" >}} 識 {{< audio id="sik1" >}}<br/>yu [y] 書 {{< audio id="syu1" >}}</th>
    <th class="tg-lnec"></th>
    <th class="tg-teg3">u [uː] 夫 {{< audio id="fu1" >}}<br/>u<sub>followed by -ng, -k</sub> [o] 風 {{< audio id="fung1" >}} 福 {{< audio id="fuk1" >}}</th>
  </tr>
  <tr>
